...
class DataProcessing(Uteis):
    ...
    def __init__(self, file_path="/home/domingos/Documentos/Dados/Carga Tratada/"):
        ...
        if self._file_path:
            ...
            with ThreadPoolExecutor() as executor:
                ...
                if dfs:
                    ...
                    # df_final["Data de triagem"] = pd.to_datetime(
                    #     df_final["Data de triagem"], dayfirst=True).date
...
if __name__ == "__main__":
    # Exemplo de uso
    # Obter os dados
    file_path_carga_tratada = "/home/domingos/Documentos/Dados/Carga Tratada/"
