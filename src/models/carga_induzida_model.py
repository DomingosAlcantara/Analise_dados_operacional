"""Classe para modelagem da carga induzida nas máquinas de triagem automatizadas
...
class CargaInduzidaModel():
    ...
    relacionados à carga induzida nas máquinas de triagem nos centros de tratamento.
    """
